...
wget -O hcclient https://github.com/AnnikaV9/hcclient/releases/download/v1.10.0/hcclient-1.10.0-linux-x86-64

# Or the statically linked binary if the above one doesn't work
wget -O hcclient https://github.com/AnnikaV9/hcclient/releases/download/v1.10.0/hcclient-1.10.0-linux-x86-64-static
...
wget https://github.com/AnnikaV9/hcclient/releases/download/v1.10.0/hcclient-1.10.0-image.tar.xz

# Install the image
docker/podman load -i hcclient-1.10.0-image.tar.xz
