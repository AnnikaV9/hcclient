...
wget https://github.com/AnnikaV9/hcclient/releases/download/v1.1.0/hcclient-1.1.0-image.tar.xz
...
wget https://github.com/AnnikaV9/hcclient/archive/refs/tags/v1.1.0.tar.gz
